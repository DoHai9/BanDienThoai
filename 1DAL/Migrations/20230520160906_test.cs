    ...
    public partial class test : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Hà Nam", 1, 1, new DateTime(2023, 5, 20, 23, 9, 6, 337, DateTimeKind.Local).AddTicks(8367), "0336253482", "Ngô Quốc Mạnh", 0, "123" });

            migrationBuilder.InsertData(
                table: "NhanVien",
                columns: new[] { "MaNV", "DiaChi", "GioiTinh", "MaCV", "NgaySinh", "SDT", "TenNV", "TrangThai", "matKhau" },
                values: new object[] { 2, "Tuyên Quang", 1, 2, new DateTime(2023, 5, 20, 23, 9, 6, 337, DateTimeKind.Local).AddTicks(8352), "0365652454", "Đỗ Văn Hải", 0, "123" });
